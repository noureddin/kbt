...
arak/index.html: .p/* arak/.?? arak/.mapping.min.js s/ar-words.js s/ar.min.js s/style.min.css .p/html-minify.pl
	...
	@cat .p/html.html | perl -CDAS -Mutf8 .p/applyini.pl .p/arabic.ini keyboard=arak title='أراك — مدرب لوحات المفاتيح' | perl -CDAS -Mutf8 .p/hash-for-cache.pl arak | perl -CDAS -Mutf8 .p/mkkb.pl | perl -CDAS -Mutf8 .p/minifier.pl html | tr -d '\n' | perl -CDAS -Mutf8 .p/mklessons.pl arak/.ls | perl -CDAS -Mutf8 .p/mapping.pl arak > arak/index.html
...
dv-ar/index.html: .p/* dv-ar/.?? dv-ar/.mapping.min.js s/ar-words.js s/ar.min.js s/style.min.css .p/html-minify.pl
	...
	@cat .p/html.html | perl -CDAS -Mutf8 .p/applyini.pl .p/arabic.ini keyboard=dv-ar title='لوحة دڤوراك العربية الصوتية (تجريبية) — مدرب لوحات المفاتيح' | perl -CDAS -Mutf8 .p/hash-for-cache.pl dv-ar | perl -CDAS -Mutf8 .p/mkkb.pl | perl -CDAS -Mutf8 .p/minifier.pl html | tr -d '\n' | perl -CDAS -Mutf8 .p/mklessons.pl dv-ar/.ls | perl -CDAS -Mutf8 .p/mapping.pl dv-ar > dv-ar/index.html
...
ibm-ar/index.html: .p/* ibm-ar/.?? ibm-ar/.mapping.min.js s/ar-words.js s/ar.min.js s/style.min.css .p/html-minify.pl
	...
	@cat .p/html.html | perl -CDAS -Mutf8 .p/applyini.pl .p/arabic.ini keyboard=ibm-ar title='لوحة المفاتيح العربية الشائعة (IBM) — مدرب لوحات المفاتيح' | perl -CDAS -Mutf8 .p/hash-for-cache.pl ibm-ar | perl -CDAS -Mutf8 .p/mkkb.pl | perl -CDAS -Mutf8 .p/minifier.pl html | tr -d '\n' | perl -CDAS -Mutf8 .p/mklessons.pl ibm-ar/.ls | perl -CDAS -Mutf8 .p/mapping.pl ibm-ar > ibm-ar/index.html
...
dvorak/index.html: .p/* dvorak/.?? dvorak/.mapping.min.js s/en-words.js s/en.min.js s/ltr-style.min.css .p/html-minify.pl
	...
	@cat .p/html.html | perl -CDAS -Mutf8 .p/applyini.pl .p/english.ini keyboard=dvorak title='Dvorak (DSK) — Keyboard Trainer' | perl -CDAS -Mutf8 .p/hash-for-cache.pl dvorak | perl -CDAS -Mutf8 .p/mkkb.pl | perl -CDAS -Mutf8 .p/minifier.pl html | tr -d '\n' | perl -CDAS -Mutf8 .p/mklessons.pl dvorak/.ls | perl -CDAS -Mutf8 .p/mapping.pl dvorak > dvorak/index.html
